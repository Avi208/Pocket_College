...
public class Faculty_Welcome_Screen extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addIAMarks = (ImageView) findViewById(R.id.add_ia_marks);
        ...
        addIAMarks.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(Faculty_Welcome_Screen.this, AddInternalMarksActivity.class);
                startActivity(intent);
            }
